...
def choose_it(driver, sit_avilable, idx, reading_room, day_type, max_attempts=500):
    ...
    bool: 预约是否成功
    """
    dir_time = {3: [['09:00', '15:00'], ['09:00', '15:00']], 2: [['14:00', '18:00'], ['18:00', '22:00']]}
        ...
        try:
            ...
            if reserve_box:
                ...
                if times_roll:
                    ...
                    if all(time in time_texts for time in get_time_range(full_day_times,"09:00","15:00")):
                        print(f"找到全天可预约座位: {i}")
                        found_full_day = True
                        day_type = 3
...
def main():
    """主函数：循环登录多个账号并执行操作"""
    account_password4 = {
        "4032330085": "czl522623",
        "4032330085": "czl522623"
    }
    sit_avilable, day_type = None, None
    users = {"自定义": [account_password4, "三楼理科书库", "45"]}
    user = "自定义"
