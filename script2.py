...
def choose_it(driver, sit_avilable, idx, reading_room, day_type, max_attempts=500):
    ...
    bool: 预约是否成功
    """
    dir_time = {3: [['15:00', '21:00'], ['15:00', '21:00']], 2: [['14:00', '18:00'], ['18:00', '22:00']]}
...
def main():
    ...
    sit_avilable, day_type = None, None
    users = {"自定义": [account_password4, "三楼理科书库", "112"]}
    user = "自定义"
    ...
    for idx, (account, password) in enumerate(total_accounts):
        ...
        try:
            ...
            profile_dir = tempfile.mkdtemp(prefix=f"edge_profile_{unique_suffix}_{idx}_2")
